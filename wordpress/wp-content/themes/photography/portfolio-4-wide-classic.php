<?php
/**
 * Template Name: Portfolio 4 Columns Wide Classic
...
<div class="inner">
	...
	<div class="element grid classic4_cols <?php echo esc_attr($portfolio_item_set); ?>" data-type="<?php echo esc_attr($portfolio_item_set); ?>">
		...
		<div class="one_fourth gallery4 classic static filterable gallery_type animated<?php echo esc_attr($key+1); ?>" data-id="post-<?php echo esc_attr($key+1); ?>">
		<?php 
			...
			?>		
				<?php
					...
					<div id="portfolio_desc_<?php echo esc_attr($portfolio_ID); ?>" class="portfolio_desc portfolio4 wide filterable">
