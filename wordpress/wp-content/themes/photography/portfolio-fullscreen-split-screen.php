		    	...
		    	<div class="gallery_archive_info split <?php echo esc_attr($content_class); ?>">
		    		<div class="gallery_archive_info_wrapper">
		    			<div class="gallery_archive_info_content">
							...
							switch($portfolio_type)
						    {
						        case 'External Link':
						        	$portfolio_link_url = get_post_meta($portfolio_ID, 'portfolio_link_url', true);
						    ?>
						    <a href="<?php echo esc_url($permalink_url); ?>" class="button ghost"><?php esc_html_e('Open Link', 'photography-translation' ); ?></a>
						...
						<?php
						    ...
						    ?>
						   <a href="<?php echo esc_url($permalink_url); ?>" class="button ghost"><?php esc_html_e('View Portfolio', 'photography-translation' ); ?></a>
						...
						<?php
						        ...
						        case 'Image':
						    ?>
						     <a data-caption="<?php echo esc_attr(get_the_title()); ?>" href="<?php echo esc_url($image_url[0]); ?>" class="fancy-gallery button ghost"><?php esc_html_e('View Image', 'photography-translation' ); ?></a>
						...
						<?php
						        ...
						        case 'Youtube Video':
						    ?>
						    <a href="https://www.youtube.com/embed/<?php echo esc_attr($portfolio_video_id); ?>" class="lightbox_youtube button ghost" data-options="width:900, height:488"><?php esc_html_e('Play Video', 'photography-translation' ); ?></a>
						...
						<?php
						        ...
						        case 'Vimeo Video':
						    ?>
						    <a href="https://player.vimeo.com/video/<?php echo esc_attr($portfolio_video_id); ?>?badge=0" class="lightbox_vimeo button ghost" data-options="width:900, height:506"><?php esc_html_e('Play Video', 'photography-translation' ); ?></a>
						<?php
						        break;
						        //end vimeo video
						    ...
						    ?>
						    <a href="<?php echo esc_url($portfolio_mp4_url); ?>" class="lightbox_vimeo button ghost"><?php esc_html_e('Play Video', 'photography-translation' ); ?></a>
