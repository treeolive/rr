...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post_wrapper">
	    ...
	    <div class="post_content_wrapper">
	    	...
	    	?>
	    	<div class="one_half">
	    		<h5 class="event_title"><?php esc_html_e('Detail', 'photography-translation' ); ?></h5>
	    		<?php
				    the_content();
				?>
				<div class="post_button_wrapper textalignleft">
					<?php
						...
						{
					?>
					<a class="button buyticket" href="<?php echo esc_url($event_ticket_url[0]); ?>" target="_blank"><?php echo esc_html_e('Buy Ticket', 'photography-translation' ); ?></a>
					<?php
						}
					?>
				</div>
		    	...
		    	<div class="post_header textalignleft">
				    <div class="post_header_title">
				    	<?php
				    		...
				    		{
				    	?>
				    	<h5 class="event_title"><?php esc_html_e('Start Date', 'photography-translation' ); ?></h5>
				    	...
				    	<?php
				    		...
				    		{
				    	?>
				    		<h5 class="event_title"><?php esc_html_e('Location', 'photography-translation' ); ?></h5>
					    	...
					    	<br class="clear"/>
					    	<div class="post_button_wrapper textalignleft">
								<a class="readmore" target="_blank" href="https://maps.google.com?saddr=Current+Location&daddr=<?php echo urlencode($event_location); ?>"><?php echo esc_html_e('Get Directions', 'photography-translation' ); ?> →</a>
							</div>
					    	<?php
					    		}
				    		}
