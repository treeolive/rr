	        ...
	        <div id="nav_wrapper">
		    	...
		    	<div id="logo_right_button">
					...
					<div class="post_share_wrapper">
						<a id="page_share" class="tooltip" href="javascript:;" title="<?php esc_html_e('Share', 'photography-translation' ); ?>"><i class="fa fa-share-alt"></i></a>
					</div>
					<?php
						global $photography_page_gallery_id;
						$post_type = get_post_type();
					...
					<div class="view_fullscreen_wrapper">
						<a class="tooltip" id="page_maximize" href="javascript:;" title="<?php esc_html_e('View Fullscreen', 'photography-translation' ); ?>"><i class="fa fa-expand"></i></a>
						<a class="tooltip" id="page_minimize" href="javascript:;" title="<?php esc_html_e('Exit Fullscreen', 'photography-translation' ); ?>"><i class="fa fa-compress"></i></a>
					</div>
					<?php
						}
					?>
					...
					<div class="header_cart_wrapper">
					    ...
					    <a class="tooltip" href="<?php echo esc_url($cart_url); ?>" title="<?php esc_html_e('View Cart', 'photography-translation' ); ?>"><i class="fa fa-shopping-cart"></i></a>
					</div>
					<?php
					}
					?>
