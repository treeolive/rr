...
if(empty($term))
{
	wp_enqueue_script("photography-script-flow-portfolio", get_template_directory_uri()."/templates/script-flow-portfolio.php", false, THEMEVERSION, true);
}
else
{
	wp_enqueue_script("photography-script-flow-portfolio", get_template_directory_uri()."/templates/script-flow-portfolio.php?portfolioset=".$term, false, THEMEVERSION, true);
}
?>
