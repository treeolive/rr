<?php
/**
 * Template Name: Portfolio 3 Columns Contained Classic
...
<div class="inner">
	...
	<div class="element grid classic3_cols <?php echo esc_attr($portfolio_item_set); ?>" data-type="<?php echo esc_attr($portfolio_item_set); ?>">
		...
		<div class="one_third gallery3 classic static filterable gallery_type animated<?php echo esc_attr($key+1); ?>" data-id="post-<?php echo esc_attr($key+1); ?>">
		<?php 
