...
?>
	...
	<div id="ppb_page_content">
		<div class="ppb_page_title_bar">
			<div class="ppb_page_title">
				<a id="ppb_open_dev_bar" title="<?php esc_html_e('Open Developer View', 'photography-translation' ); ?>"><span class="dashicons dashicons-list-view"></span></a>
				
				<a id="ppb_open_templates" href="#ppb_template" class="pp_fancybox_inline"><?php esc_html_e('Templates', 'photography-translation' ); ?></a>
				
				<a id="ppb_preview_page" data-action="<?php echo esc_url(admin_url('admin-ajax.php?action=photography_ppb_preview_page_set_data')); ?>" data-preview="<?php echo esc_url(admin_url('admin-ajax.php?action=photography_ppb_preview_page&ppb_post_type=page&page_id='.$post->ID)); ?>" data-page="<?php echo esc_attr($post->ID); ?>"><?php esc_html_e('Preview', 'photography-translation' ); ?></a>
	...
	?>
	    	<li id="<?php echo esc_attr($ppb_form_item); ?>" class="ui-state-default <?php echo esc_attr($ppb_form_item_size[0]); ?> <?php echo esc_attr($ppb_form_item_data_obj->shortcode); ?>" data-current-size="<?php echo esc_attr($ppb_form_item_size[0]); ?>" data-shortcode="<?php echo esc_attr($ppb_shortocde_title); ?>" data-icon="<?php echo esc_url($ppb_shortcode_icon); ?>">
	    		<div class="size">
	    			<a href="javascript:;" title="<?php esc_html_e('Increase Size', 'photography-translation' ); ?>" class="ppb_plus button">+</a>
	    			<a href="javascript:;" title="<?php esc_html_e('Decrease Size', 'photography-translation' ); ?>" class="ppb_minus button">-</a>
	    		</div>
	    		...
	    		<div class="item_action">
	    			<a href="javascript:;" class="ppb_remove" title="<?php esc_html_e('Remove', 'photography-translation' ); ?>"><i class="fa fa-trash"></i></a>
					
					<a href="javascript:;" class="ppb_duplicate" title="<?php esc_html_e('Duplicate', 'photography-translation' ); ?>"><i class="fa fa-copy"></i></a>
					
					<a data-rel="<?php echo esc_attr($ppb_form_item); ?>" href="<?php echo esc_url(admin_url('admin-ajax.php?action=photography_ppb&ppb_post_type=page&shortcode='.$ppb_form_item_data_obj->shortcode.'&rel='.$ppb_form_item.'&width=800&height=900&page_id='.$post->ID)); ?>" class="ppb_edit" title="<?php esc_html_e('Edit', 'photography-translation' ); ?>"><i class="fa fa-edit"></i></a>
					
					<a data-rel="<?php echo esc_attr($ppb_form_item); ?>" href="javascript:;" class="ppb_add_after" title="<?php esc_html_e('Add Content After This', 'photography-translation' ); ?>"><i class="fa fa-plus"></i></a>
	    		</div>
	...
	<div id="ppb_add_content_wrapper" <?php if(!empty($count_ppb)) { ?>class="not_started"<?php } ?>>
	    ...
	    <div id="ppb_add_content_wrapper_started">
	    	<h2><?php esc_html_e('Get started', 'photography-translation' ); ?></h2>
	    ...
	    <a id="ppb_sortable_add_button" href="#ppb_tab" class="pp_fancybox_inline_fullheight" data-after=""!><i class="fa fa-plus-circle"></i><?php esc_html_e('Add Content', 'photography-translation' ); ?></a>
	    ...
	    <?php
	    	...
	    	{
	    ?>
	    <a id="ppb_sortable_template_button" href="#ppb_template" class="pp_fancybox_inline"><i class="fa fa-cloud-download"></i><?php esc_html_e('Import Template', 'photography-translation' ); ?></a>
	    <?php
	    	}
	    ?>
	</div>
