...
add_action('admin_menu', 'photography_shortcode_generator');

function photography_shortcode_generator() 
{  
	if ( function_exists('add_meta_box') ) {  
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'photography_shortcode_generator_options', 'page', 'normal', 'high' );
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'photography_shortcode_generator_options', 'post', 'normal', 'high' );  
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'photography_shortcode_generator_options', 'portfolios', 'normal', 'high' );
	}
}

function photography_shortcode_generator_options() {
